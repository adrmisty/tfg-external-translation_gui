...
public class HelpImage extends JFrame {
    ...
    public HelpImage(MainWindow root) throws ResourceException {
	...
	if (lblHelpDefault == null) {
	    lblHelpDefault = new JLabel(
		    root.getMessages().getString("help.image.title"));
	...
	if (txtDefault == null) {
	    ...
	    txtDefault
		    .setText(root.getMessages().getString("help.image.text1"));
	    ...
	    txtDefault.setBounds(20, 83, 224, 162);
	}
	return txtDefault;
    }
	...
	if (lblImage == null) {
	    ...
	    lblImage.setIcon(new ImageIcon(
		    HelpImage.class.getResource("/helpimg/help-image1.png")));
	    lblImage.setBounds(254, 40, 322, 205);
	}
	return lblImage;
    }
	...
	if (lblImage2 == null) {
	    ...
	    lblImage2.setIcon(new ImageIcon(
		    HelpImage.class.getResource("/helpimg/help-image2.png")));

	    lblImage2.setBounds(10, 256, 384, 102);
	}
	return lblImage2;
    }
	...
	if (txtDefault2 == null) {
	    ...
	    txtDefault2
		    .setText(root.getMessages().getString("help.image.text2"));
	    ...
	    txtDefault2.setBounds(412, 249, 164, 153);
	}
	return txtDefault2;
    }
}
