...
public class FileUpload extends JFrame {
	...
	setIconImage(Toolkit.getDefaultToolkit().getImage(
		FileUpload.class.getResource("/main/resources/icon.png")));
	...
	if (btnBack == null) {
	    btnBack = new JButton("");
	    btnBack.setIcon(new ImageIcon(FileUpload.class
	...
	if (btnHelp == null) {
	    ...
	    btnHelp.setIcon(new ImageIcon(
		    FileUpload.class.getResource("/main/resources/help.png")));
